...
# ─────────────────────────────────────────────────────────────────────
MAX_HEIGHT  = 84.62   # cm 有效积温表2逻辑斯谛拟合 (MAX=84.62, k=0.00422, mid=453.9; 实测稳定值 83-86cm)
...
_PARTITION_ANCHORS = [
    ...
    (35,  0.38, 0.32, 0.00, 0.15),
    (48,  0.32, 0.32, 0.06, 0.15),
    (57,  0.20, 0.22, 0.42, 0.13),
    (70,  0.12, 0.20, 0.55, 0.13),
    (76,  0.07, 0.18, 0.63, 0.12),   # 打顶日
    (84,  0.05, 0.12, 0.73, 0.10),
    (100, 0.02, 0.06, 0.84, 0.08),
...
TOPPING_LEAF_LOSS_FRAC_STD = 0.18
...
def run_simulation(weather_path: str) -> pd.DataFrame:
    ...
    for i in range(DAYS):
        ...
        height = MAX_HEIGHT / (1 + np.exp(-0.00422 * (gdd_ae - 453.9)))
...
if __name__ == '__main__':
    ...
    print("=" * 70)
    print("单独cotton2k  —  新疆阿拉尔 塔河2号 (2025)")
    print("=" * 70)
