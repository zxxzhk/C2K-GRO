...
密度:    20 万株/hm² = 20 株/m²
播种:    2022-04-21  出苗: 2022-05-01  打顶: 2022-07-13 (播后83天, DAE=73) [2022对照年]
"""
...
BOLL_COUNT_TARGET  = 8.2   # 2022对照年实测综合均值
...
MEASURED_LINT_KGHA  = 2948.0   # 2022对照年实测皮棉 (7020×0.420=2948 kg/ha)
...
# 实测产量 + 单株
MEASURED_OPEN_BOLLS_PER_PLANT    = 8.2   # 2022对照年实测结铃数均值
...
def run_daily_coupling(
    ...
    print('=' * 70)
    print(f'  cotton2k与GroIMP耦合 — 逐日耦合服务器 [2022验证年]')
    ...
    print(f'  实测籽棉: {MEASURED_SEED_KGHA:.0f} kg/ha → 皮棉: {MEASURED_LINT_KGHA:.0f} kg/ha (衣分42%) [2022对照年]')
    print('=' * 70)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description=f'cotton2k与GroIMP耦合 — 逐日耦合服务器 [2022对照年] '
